...
Instapaper is a read-later service that saves articles, blog posts, and web pages in a clean, distraction-free format. For doctoral research, it functions as a **staging area** between finding a source and formally integrating it into your literature review.

**Website:** [https://www.instapaper.com](https://www.instapaper.com)
...
Instapaper uses **Folders** (analogous to categories). Create the following folder structure to mirror your research organization:

```
📁 Queue (default — everything unread lands here)
📁 01 — Foundational Texts
📁 02 — Research Methods & Design
📁 03 — CS Education
📁 04 — Cybersecurity & Pedagogy
📁 05 — Equity & Access in CS
📁 06 — Faith & Higher Education
📁 07 — Current Research (Last 5 Years)
📁 08 — Comprehensive Exam Prep
📁 09 — Dissertation Sources
📁 10 — Teaching Resources (not research — separate)
📁 ✅ Archived — Read & Processed
```

**Workflow:** Save → stays in Queue → read and annotate → move to appropriate folder → when notes are completed and filed, move to Archived.

### 1.3 Saving Content to Instapaper

**Method 1 — Browser Extension**  
Click the Instapaper extension button on any article or web page. It saves immediately to your Queue.
...
Instapaper Premium allows you to highlight text in four colors. Use this system:

| Color | Meaning |
|---|---|
| 🟡 Yellow | Key argument or main claim |
| 🔵 Blue | Directly relevant to dissertation |
| 🔴 Red | Challenges my thinking / disagree |
| 🟢 Green | Relevant to comprehensive exam prep |

**Adding notes to highlights:**  
After highlighting, tap the highlight to add a note. Use this for your in-the-moment reactions:
- `Q: [question this raises]`
- `cf: [compare to another source]`
- `→ lit review: [theme]`
- `!: [surprising or important]`

### 1.5 Exporting Highlights for Your Reading Notes

After finishing an article:

1. Open the article in Instapaper
2. Tap the share icon → "Export Highlights"
3. Copy to clipboard or export to your notes app
4. Paste into the relevant reading notes `.md` file in your GitHub repo

**Premium users:** Instapaper integrates with **Readwise**, which can automatically export your highlights to Markdown, Notion, Obsidian, or other tools.

### 1.6 Instapaper Search and Review

Use the search feature to:
- Find all articles on a specific theme before writing a section of your literature review
- Locate a specific quote or claim you remember highlighting
- Identify gaps — topics you've saved but haven't read yet

**Monthly review practice:** At the end of each month, review your Queue. Archive everything that's been processed, delete saved items that are no longer relevant, and move unread items to a "Review" tag.
...
- 1.2x–1.5x — Standard academic articles in your field
- 1.5x–2.0x — Review material you've already read; skimming for key passages
...
|---|---|---|
| Morning commute (each way) | 20–30 min | New article from Instapaper queue |
| Exercise / walking | 30–60 min | Foundational text chapter or re-listen |
| Evening wind-down | 15–20 min | Light review — previously read material |
| Long drive | 60–90 min | Systematic playlist by research theme |

---

## Tool Integration — The Full Research Workflow

```
DISCOVER                SAVE                  ORGANIZE
──────────             ──────────            ──────────
Google Scholar    →    Instapaper            Instapaper Folders
JSTOR / EBSCOhost →    (browser extension    (by research theme)
Twitter/X         →    or share sheet)
Email newsletter  →
...
──────────────────       ──────────────────────────────────────
Meeting packet       →   Literature Review
Weekly log commit    →   Dissertation Chapters
GitHub push          →   Comprehensive Exam Responses
```
...
|---|---|---|---|
| **Zotero** | Citation management, bibliography | Desktop / Web | Free |
| **Google Scholar** | Article discovery, citation tracking | Web | Free |
| **JSTOR** | Full-text academic journals | Web | Institutional access |
| **ResearchGate** | Discover & request papers from authors | Web | Free |
| **Readwise** | Sync Instapaper highlights to Markdown | Web / Mobile | ~$8/month |
| **Obsidian** | Linked Markdown note-taking | Desktop | Free |
| **VS Code** | Markdown editing with GitHub integration | Desktop | Free |
...
| Problem | Solution |
|---|---|
| Instapaper won't load article cleanly | Use "Mobilize" or try saving a different version of the URL |
| @Voice mispronounces key terms | Use the pronunciation dictionary feature to add corrections |
| PDF text not reading | Open in Google Drive first → Download as plain text |
| Articles not syncing to @Voice | Force-sync in @Voice settings; check Instapaper login |
| Highlights not showing after export | Re-sync; check Premium subscription status |
